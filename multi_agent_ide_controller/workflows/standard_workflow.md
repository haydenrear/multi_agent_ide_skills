...
- No growth across 2-3 polls → stalled → load `multi_agent_ide_debug` skill, check `executables/reference.md` for the right log search script, then triage from there.
