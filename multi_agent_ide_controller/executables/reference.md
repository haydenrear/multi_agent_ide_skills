...
| `conversations.py <nodeId>` | List active agent-to-controller conversations. Use `--last N` for last N messages, `--respond --message "..."` to respond to pending request, `--pending` for unresponded requests only. |
